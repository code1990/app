...
class Chapter0654LoginForgetActivity : AppCompatActivity() {
    ...
    private inner class HideTextWatcher(private val mView: EditText) : TextWatcher {
        private val mMaxLength: Int = Chapter0654ViewUtil.getMaxLength(mView)
        ...
        override fun afterTextChanged(s: Editable) {
            ...
            if (mStr!!.length == 11 && mMaxLength == 11 || mStr!!.length == 6 && mMaxLength == 6) {
                ...
                //Chapter0654ViewUtil.hideOneInputMethod(this@Chapter0654LoginPageActivity, mView)
            }
        }
    }
    ...
    private fun doForget() {
        ...
        if (rb_password.isChecked) {
            //携带手机号码跳到密码找回页面
            startActivityForResult<Chapter0654LoginPageActivity>(mRequestCode, "phone" to phone)
